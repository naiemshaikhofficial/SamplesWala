      ...
      <div className="flex-1 flex items-center justify-center container mx-auto px-4 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-black uppercase italic tracking-tighter mb-4 italic leading-tight">Join the Studio</h1>
            <p className="text-white/40 text-sm">Start your journey as a producer. Get your first credits now.</p>
          </div>
          ...
          <div className="flex items-center gap-4 mb-8 text-white/10">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em]">OR SIGNUP WITH EMAIL</span>
            <div className="h-[1px] flex-1 bg-current" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center px-4">
               <p className="text-[10px] uppercase font-black tracking-widest text-white/20 mb-6 flex items-center justify-center gap-2">
                 Already a member? 
                 <Link href="/auth/login" className="text-white hover:text-yellow-500 transition-colors underline underline-offset-4">Login</Link>
               </p>
            </div>
