            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
                {samples.map((sample, index) => (
                    <motion.div 
                        ...
                        className="group relative bg-[#0a0a0a] border border-white/5 p-6 hover:bg-[#111] transition-all hover:border-studio-neon/30"
                    >
                         {/* Signal Indicator */}
